...
describe("SectionNav", () => {
  it("marks the active section with aria-current", () => {
    ...
    expect(screen.getByText("Voxely (локальная)")).toBeInTheDocument();
    ...
    expect(screen.getByRole("button", { name: /Отладка/ })).toBeInTheDocument();
  });
  ...
  it("hides debug and the local suffix in a production build", () => {
    ...
    expect(screen.queryByRole("button", { name: /Отладка/ })).not.toBeInTheDocument();
